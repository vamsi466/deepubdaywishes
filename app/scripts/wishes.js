  (function(){
      ...
      .controller("flipPhoto",['$scope','shuffleItems','$timeout','$interval', function($scope,shuffleItems,$timeout,$interval){
          ...
          var videosArr = ["Ragha and Namratha","Sreelatha","Roja","Suma","Sravya and Madhu","Vinitha","Nidhi","Hema","Ramya","Sravanthi","Jenny","Mahalakshmi","Raghavendra","Namratha","Gnaneshwari","Praneeth","Nandini","Santu","Nagalatha","Charan","Soni","Amma","Nanna"]
